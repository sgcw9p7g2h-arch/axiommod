...
public partial class MainWindow : Window
{
    ...
    private const string AxiomRepository = "sgcw9p7g2h-arch/axiommod";
    ...
    private async void LaunchButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var fabricVersionName = await fabricInstaller.Install(
                MinecraftVersion,
                FabricLoaderVersion,
                path);
    ...
    private async Task EnsureLatestAxiomModAsync(MinecraftPath path)
    {
        ...
        var remoteDigest = asset.TryGetProperty("digest", out var digestElement)
